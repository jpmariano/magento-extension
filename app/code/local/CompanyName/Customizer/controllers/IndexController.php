...
class TargetedVictory_Customizer_IndexController extends Mage_Core_Controller_Front_Action
{
    /**
   ...
   public function updateItemOptionsAction()
     ...
     */
    public function updatePostRewriteAction()
    {
        ...
        switch ($updateAction) {
            case 'empty_cart':
                ...
                break;
            case 'update_qty':
                $this->_updateShoppingCartRewrite();
                break;
            default:
                $this->_updateShoppingCartRewrite();
        }
     ...
     */
    protected function _updateShoppingCartRewrite()
    {
        try {
